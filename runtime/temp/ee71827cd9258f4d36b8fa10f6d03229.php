			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<a class="btn btn-info" href="<?php echo url('rules/add'); ?>">新增</a>
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th class="center">权限规则</th>
												<th class="center">权限图标</th>
												<th class="center">菜单显示</th>
										...
										<?php foreach($list as $k=>$v): ?>
											...
											<tr>
												...
												<td class="center">
													<?php echo $v['rule_address']; ?>
												</td>	
												<td class="center">
													<i class="ace-icon fa fa-<?php echo $v['rule_icon']; ?>"></i>
												</td>
												<td class="center <?php echo $v['is_menu']==1?'text-primary':''; ?>">

												<?php echo $v['is_menu']==1?'显示':'不显示'; ?>
													
												</td>
												<td class="center <?php echo $v['status']==1?'text-primary':''; ?>">

													<?php echo $v['status']==1?'显示':'不显示'; ?>
												</td>
												
												<td class="center">
													<a href="<?php echo url('rules/edit',['id'=>$v['id']]); ?>" class='btn btn-primary' >修改</a>
...
<script type="text/javascript">
	...
	function del(obj){
		...
		layer.confirm('确定要删除，删除后不可恢复！',function(){
			$.post("<?php echo url('rules/delete'); ?>",{id:id},function(data){
				...
				if (data.code==1) {
					layer.alert(data.msg,{icon:1},function(res){
						...
						layer.close(res);
						window.location.href="<?php echo url('rules/index'); ?>";
					})
				}else{
