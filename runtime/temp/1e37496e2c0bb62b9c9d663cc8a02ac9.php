				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									<form class="form-inline" action="<?php echo url('article/index'); ?>"" method="get">
