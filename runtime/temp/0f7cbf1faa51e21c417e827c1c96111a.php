		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<!-- <div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('about/add'); ?>" method="post" enctype="multipart/form-data">
								
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 邮箱：</label>
									<div class="col-sm-9">
										<input type="email" required name="email" class="rcol-xs-10 col-sm-5" value="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" required name="wechat" class="rcol-xs-10 col-sm-5" value="">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 知乎：</label>
									<div class="col-sm-9">
										<input type="text" required name="zhihu" class="rcol-xs-10 col-sm-5" value="">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Instagram：</label>
									<div class="col-sm-9">
										<input type="text" required name="instagram" class="rcol-xs-10 col-sm-5" value="">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('about/edit'); ?>" method="post">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 邮箱：</label>
									<div class="col-sm-9">
										<input type="email" required name="email" class="rcol-xs-10 col-sm-5" value="<?php echo $info['email']; ?>">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 微信：</label>
									<div class="col-sm-9">
										<input type="text" required name="wechat" class="rcol-xs-10 col-sm-5" value="<?php echo $info['wechat']; ?>">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 知乎:</label>
									<div class="col-sm-9">
										<input type="text" required name="zhihu" class="rcol-xs-10 col-sm-5" value="<?php echo $info['zhihu']; ?>">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> instagram：</label>
									<div class="col-sm-9">
										<input type="text" required name="instagram" class="rcol-xs-10 col-sm-5" value="<?php echo $info['instagram']; ?>">
								...
								<div class="form-group">
									...
									<div class="control-label no-padding-left col-sm-1">	
										<input type="hidden" name="status" value='0'>
										<label>
											<input name="status" value="1" class="ace ace-switch ace-switch-2" type="checkbox" <?php echo $info['status']==1?"checked":""; ?> />
											<span class="lbl"></span>
										</label>
									</div>
									<span class="help-inline col-xs-12 col-sm-7">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1">详情:</label>
									<div class="col-sm-9">
										...
										<input id="text1" type="hidden"  name="content" value='<?php echo $info['content']; ?>'  />
...
<script type="text/javascript">
	var E = window.wangEditor
    	...
    	// 配置服务器端地址
    	editor.customConfig.uploadImgServer = "<?php echo url('bigshot/upload'); ?>";
