		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('background/add'); ?>" method="post">
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 文本1 </label>
									<div class="col-sm-9">
										<input type="text" name="content1" class="rcol-xs-10 col-sm-5" value="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="content2" class="rcol-xs-10 col-sm-5" value="">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="content3" class="rcol-xs-10 col-sm-5" value="">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="content4" class="rcol-xs-10 col-sm-5" value="">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div id="editor" ></div>
										<input id="text1" type="hidden" name="pic">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
