		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" id="form" name="form" action="<?php echo url('user/edit'); ?>" method="post">
							<input type="hidden" name='id' value="<?php echo $data['id']; ?>">
							<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-10">角色</label>
									<div class="col-sm-9">
										<select class="rcol-xs-10 col-sm-5" name="role_id" value=''>
											<?php foreach($list as $k=>$v): ?>
												<option value="<?php echo $v['id']; ?>" <?php echo $data['role_id']==$v['id']?'selected':''; ?>><?php echo $v['role_name']; ?></option>
											<?php endforeach; ?>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="工号" class="col-xs-10 col-sm-5" value="<?php echo $data['user_name']; ?>" name='user_name'>
										<span class="help-inline col-xs-12 col-sm-7">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="真实姓名" class="col-xs-10 col-sm-5" value="<?php echo $data['real_name']; ?>" name='real_name'>
										<span class="help-inline col-xs-12 col-sm-7">
											<span class="middle"></span>
										</span>
									</div>
