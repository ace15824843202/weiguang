						...
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									...
									<a class="btn btn-info" href="<?php echo url('article/add'); ?>">新增</a>
									<select name="type_id" class="form-control" style="width: 10%">
									<?php foreach($type as $k=>$v): if($type_id==$v['id']): ?>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<?php foreach($list as $k=>$v): ?>
											...
											<tr>
												...
												<td class="center">
													<a href="<?php echo url('article/edit',['id'=>$v['id']]); ?>" class='btn btn-primary' >修改</a>
													<?php if($v['top']==1): ?>
														<a href="javascript:void(0)" data-id="<?php echo $v['id']; ?>" type-id='<?php echo $type_id; ?>'flag='0' class ='btn btn-warning'onclick='zhiding(this)'>取消置顶</a>

													<?php else: ?>
														<a href="javascript:void(0)" data-id="<?php echo $v['id']; ?>" type-id='<?php echo $type_id; ?>' flag='1' class ='btn btn-warning'onclick='zhiding(this)'>置顶</a>
...
<script type="text/javascript">
	...
	function del(obj){
		...
		layer.confirm('确定要删除，删除后不可恢复！',function(){
			$.post("<?php echo url('article/delete'); ?>",{id:id},function(data){
	...
	function zhiding(obj){
		...
		layer.confirm(msg,function(){
			$.post("<?php echo url('article/gotop'); ?>",{id:id,type_id:type_id,flag:flag},function(data){
