<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:66:"C:\wamp64\www\tp5\public/../application/admin\view\rules\edit.html";i:1544858107;s:59:"C:\wamp64\www\tp5\application\admin\view\common\header.html";i:1544513856;s:59:"C:\wamp64\www\tp5\application\admin\view\common\navbar.html";i:1544857651;s:60:"C:\wamp64\www\tp5\application\admin\view\common\sidebar.html";i:1544757192;s:60:"C:\wamp64\www\tp5\application\admin\view\common\setting.html";i:1544514317;s:59:"C:\wamp64\www\tp5\application\admin\view\common\footer.html";i:1544514356;s:55:"C:\wamp64\www\tp5\application\admin\view\common\js.html";i:1544528949;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<!-- 头部开始 -->
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('rules/edit'); ?>" method="post">
								<input type="hidden" name="id" value="<?php echo $data['id']; ?>">
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-10">上级菜单 </label>
									<div class="col-sm-9">
										<select class="rcol-xs-10 col-sm-5" name="pid" value="">
											<option value="0" >顶级菜单</option>
											<?php foreach($list as $k=>$v): ?>
												
												<option value="<?php echo $v['id']; ?>" <?php echo $data['pid']==$v['id']?'selected':''; ?>><?php echo $v['rule_name']; ?></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name='rule_name' class="rcol-xs-10 col-sm-5" value="<?php echo $data['rule_name']; ?>">
										<span class="help-inline col-xs-12 col-sm-7">
											<span class="middle"></span>
										</span>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name='rule_address' placeholder="链接，如：Index/index" class="col-xs-10 col-sm-5" value="<?php echo $data['rule_address']; ?>">
										<span class="help-inline col-xs-12 col-sm-7">
											<span class="middle"></span>
										</span>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name='rule_icon' placeholder="ICON图标" class="col-xs-10 col-sm-5" value="<?php echo $data['rule_icon']; ?>">
										<span class="help-inline col-xs-12 col-sm-7">
								...
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-2">右侧菜单是否显示 </label>
									<div class="control-label no-padding-left col-sm-1">
										<label>
											<input type="hidden" name="is_menu" value="0" />
											<input value="1" class="ace ace-switch ace-switch-2" type="checkbox" <?php echo $data['is_menu']==1?'checked':''; ?> name="is_menu"/>
											<span class="lbl"></span>
										</label>
									</div>
									<span class="help-inline col-xs-12 col-sm-7">
								...
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 列表中是否显示  </label>
									<div class="control-label no-padding-left col-sm-1">
										<label>
											<input type="hidden" name="status" value="0" />
											<input value="1" class="ace ace-switch ace-switch-2" type="checkbox" <?php echo $data['status']==1?'checked':''; ?> name='status' />
											<span class="lbl"></span>
										</label>
									</div>
									<span class="help-inline col-xs-12 col-sm-7">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="sort" id="o" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo $data['sort']; ?>">
										<span class="help-inline col-xs-12 col-sm-7">
