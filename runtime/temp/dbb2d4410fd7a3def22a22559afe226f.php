				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									<a class="btn btn-info" href="<?php echo url('about/add'); ?>">新增</a>
								</div>
								<div class="space-4"></div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<?php if(empty($about) || (($about instanceof \think\Collection || $about instanceof \think\Paginator ) && $about->isEmpty())): ?>
												<tr>
													<td colspan='7' align='center'>暂无数据</td>
												</tr>
											<?php else: foreach($about as $v): ?>
												<tr align="center">
													<td><?php echo $v['id']; ?></td>
													<td ><?php echo $v['email']; ?></td>
													<td><?php echo $v['wechat']; ?></td>
													<td><?php echo $v['zhihu']; ?></td>
													<td><?php echo $v['instagram']; ?></td>
													<td>
														<?php if($v['status']==1): ?>
														<span style="color:green">启用</span>
														<?php else: ?>
														<span style="color:green">未启用</span>
														<?php endif; ?>
													</td>
													...
													<td class="center">
														...
														<a href="<?php echo url('about/edit',['id'=>$v['id']]); ?>" class="btn btn-primary">修改</a>

														<a href="#"  data-id="<?php echo $v['id']; ?>"  onclick="del(this)"  class="btn btn-danger">删除</a>
													</td>
												</tr>
...
<script type="text/javascript">
	...
	function del(obj){
		...
		layer.confirm('确定要删除，删除后不可恢复！',function(){
			$.post("<?php echo url('about/delete'); ?>",{id:id},function(data){
				...
				if (data.code==1) {
					layer.alert(data.msg,{icon:1},function(res){
						...
						layer.close(res);
						window.location.href="<?php echo url('about/index'); ?>";
