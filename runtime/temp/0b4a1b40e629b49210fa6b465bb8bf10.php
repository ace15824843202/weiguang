		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" id="form" name="form" action="<?php echo url('roles/add'); ?>" method="post">
												...
												<div class="widget-box">
													<div class="widget-header">
														<h4 class="widget-title">
															<label>
																<input name="role_rules[]" class="ace ace-checkbox-2 father" type="checkbox" value="<?php echo $v['id']; ?>"/>
													...
													<div class="widget-body">
														...
														<?php foreach($v['child'] as $kk=>$vv): ?>
															<label class="col-xs-2" style="width:160px;">
																<input name="role_rules[]" class="ace ace-checkbox-2 children" type="checkbox" value="<?php echo $vv['id']; ?>"/>
