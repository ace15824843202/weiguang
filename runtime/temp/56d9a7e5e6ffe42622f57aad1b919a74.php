						...
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('article/add'); ?>" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="title" class="rcol-xs-10 col-sm-5" value="">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="author" class="rcol-xs-10 col-sm-5" value="">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="editor" class="rcol-xs-10 col-sm-5" value="">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea class="rcol-xs-10 col-sm-5" rows="5" name='desc'>
...
<script type="text/javascript">
	var E = window.wangEditor
    	...
    	// 配置服务器端地址
    	editor.customConfig.uploadImgServer = "<?php echo url('article/upload'); ?>";
