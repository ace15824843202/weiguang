				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									<a class="btn btn-info" href="<?php echo url('area/add'); ?>">新增</a>
								</div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<?php foreach($list as $k=>$v): ?>
											...
											<tr>
												...
												<td class="center">
													<a href="<?php echo url('area/edit',['id'=>$v['id']]); ?>" class='btn btn-primary' title="修改">修改</a>
...
<script type="text/javascript">
	...
	function del(obj){
		...
		layer.confirm('确定要删除，删除后不可恢复！',function(){
			$.post("<?php echo url('area/delete'); ?>",{id:id},function(data){
				...
				if (data.code==1) {
					layer.alert(data.msg,{icon:1},function(res){
						...
						layer.close(res);
						window.location.href="<?php echo url('area/index'); ?>";
