						...
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									...
									<a class="btn btn-info" href="<?php echo url('bigshot/add'); ?>">新增</a>
								...
								<div class="space-4"></div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<?php if($list[0]['id']==null): ?>
												<tr>
													<td colspan='6' align='center'>暂无数据</td>
												</tr>
											<?php else: foreach($list as $list): ?>
												<tr align="center">
													<td><?php echo $list['id']; ?></td>
													<td><?php echo $list['name']; ?></td>
													<td><img src="<?php echo $list['pic']; ?>" width="50px" alt=""></td>

													<td>
														 <?php 

			                                        $arr = explode(",",$list['field']);
			                                       ...
			                                       for($i=0;$i < count($arr);$i++){
													...
													<?php foreach($area as $v): if($v['id']==$list['area']): ?>
															<td><?php echo $v['area']; ?></td>
														<?php endif; endforeach; ?>

													<td><?php echo $list['expire']; ?></td>
													...
													<td class="center">
														...
														<a href="<?php echo url('bigshot/edit',['id'=>$list['id']]); ?>" class="btn btn-primary">详情</a>

														<a href="javascript:void(0)"  data-id="<?php echo $list['id']; ?>"  onclick="del(this)"  class="btn btn-danger">删除</a>
													</td>
												</tr>
...
<script type="text/javascript">
	...
	function del(obj){
		...
		layer.confirm('确定要删除，删除后不可恢复！',function(){
			$.post("<?php echo url('bigshot/delete'); ?>",{id:id},function(data){
				...
				if (data.code==1) {
					layer.alert(data.msg,{icon:1},function(res){
						...
						layer.close(res);
						window.location.href="<?php echo url('bigshot/index'); ?>";
					})
				}else{
