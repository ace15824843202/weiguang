		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('bigshot/add'); ?>" method="post" enctype="multipart/form-data">
													...
													<div class="widget-body">
														<div class="widget-main row">
															...
															<label class="col-xs-2" style="width:160px;">
																<input name="field[]" class="ace ace-checkbox-2 children" type="checkbox" value="<?php echo $v['id']; ?>"/>
																<span class="lbl"><?php echo $v['field']; ?></span>
															</label>
															<?php endforeach; ?>
														</div>
													</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<?php $__FOR_START_27158__=0;$__FOR_END_27158__=30;for($i=$__FOR_START_27158__;$i < $__FOR_END_27158__;$i+=1){ ?>
											
											<option value="<?php echo $i; ?>" <?php echo $i==5?'selected':''; ?>><?php echo $i; ?>年</option>
