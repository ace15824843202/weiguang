		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" id="form" name="form" action="<?php echo url('roles/edit'); ?>" method="post">
								<input type="hidden" name='id' value="<?php echo $data['id']; ?>">
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 角色名称</label>
									<div class="col-sm-9">
										<input type="text" placeholder="角色名" class="col-xs-10 col-sm-5" value="<?php echo $data['role_name']; ?>" name='role_name'>
								...
								<div class="form-group">
									...
									<div class="control-label no-padding-left col-sm-1">
										<label>
											...
											<input class="ace ace-switch ace-switch-2" type="checkbox" <?php echo $data['status']==1?'checked':''; ?> name ="status" value="1" />
											<span class="lbl"></span>
										</label>
									</div>
									<span class="help-inline col-xs-12 col-sm-7">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="col-sm-10">
										<?php foreach($allrule as $k=>$v): ?>
											<div class="row">
												<div class="widget-box">
													<div class="widget-header">
														<h4 class="widget-title">
															<label>
																<input name="role_rules[]" class="ace ace-checkbox-2 father" type="checkbox" <?php echo $v['checked']=='true'?'checked':''; ?> value="<?php echo $v['id']; ?>"/>
																<span class="lbl"> <?php echo $v['rule_name']; ?></span>
															</label>
														</h4>
													...
													<div class="widget-body">
														...
														<?php foreach($v['child'] as $kk=>$vv): ?>
															<label class="col-xs-2" style="width:160px;">
																<input name="role_rules[]" class="ace ace-checkbox-2 children" type="checkbox" <?php echo $vv['checked']=='true'?'checked':''; ?> value="<?php echo $vv['id']; ?>"/>
																<span class="lbl"><?php echo $vv['rule_name']; ?></span>
															</label>
														<?php endforeach; ?>
														</div>
													</div>
