			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<a class="btn btn-info" href="<?php echo url('roles/add'); ?>">新增</a>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<?php foreach($list as $k=>$v): ?>
											...
											<tr>
												...
												<td class="center">
													<a href="<?php echo url('roles/edit',['id'=>$v['id']]); ?>" class='btn btn-primary' >修改</a>
...
<script type="text/javascript">
	...
	function del(obj){
		...
		layer.confirm('确定要删除，删除后不可恢复！',function(){
			$.post("<?php echo url('roles/delete'); ?>",{id:id},function(data){
				...
				if (data.code==1) {
					layer.alert(data.msg,{icon:1},function(res){
						...
						layer.close(res);
						window.location.href="<?php echo url('roles/index'); ?>";
					})
				}else{
