		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('toptype/edit'); ?>" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="name" class="rcol-xs-10 col-sm-5" value="<?php echo $data['name']; ?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="order" class="rcol-xs-10 col-sm-5" value="<?php echo $data['order']; ?>">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
