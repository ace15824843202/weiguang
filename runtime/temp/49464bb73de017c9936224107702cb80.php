			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<a class="btn btn-info" href="<?php echo url('user/add'); ?>">新增</a>
										...
										<?php foreach($list as $k=>$v): ?>
											...
											<tr>
												...
												<td class="center <?php echo $v['status']==1?'text-primary':''; ?>">
													...
													<?php echo $v['status']==1?'启用':'不启用'; ?>
												</td>
												
												<td class="center">
													<a href="<?php echo url('user/edit',['id'=>$v['id']]); ?>" class='btn btn-primary' >修改</a>
