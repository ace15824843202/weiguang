		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('area/edit'); ?>" method="post">
							<input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 领域名称 </label>
									<div class="col-sm-9">
										<input type="text" name="area" class="rcol-xs-10 col-sm-5" value="<?php echo $data['area']; ?>">
