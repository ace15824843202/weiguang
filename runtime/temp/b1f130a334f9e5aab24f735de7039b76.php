		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('about/add'); ?>" method="post">
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 邮箱：</label>
									<div class="col-sm-9">
										<input type="email" required name="email" class="rcol-xs-10 col-sm-5" value="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div id="editor" ></div>
										<input id="text1" type="hidden" name="content">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
