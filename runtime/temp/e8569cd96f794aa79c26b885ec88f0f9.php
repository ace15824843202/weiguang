<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:71:"C:\wamp64\www\tp5\public/../application/admin\view\background\edit.html";i:1544534451;s:59:"C:\wamp64\www\tp5\application\admin\view\common\header.html";i:1544513856;s:59:"C:\wamp64\www\tp5\application\admin\view\common\navbar.html";i:1544756774;s:60:"C:\wamp64\www\tp5\application\admin\view\common\sidebar.html";i:1544757192;s:60:"C:\wamp64\www\tp5\application\admin\view\common\setting.html";i:1544514317;s:59:"C:\wamp64\www\tp5\application\admin\view\common\footer.html";i:1544514356;s:55:"C:\wamp64\www\tp5\application\admin\view\common\js.html";i:1544528949;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<!-- 头部开始 -->
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form class="form-horizontal" action="<?php echo url('background/edit'); ?>" method="post">
								<input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 文本1 </label>
									<div class="col-sm-9">
										<input type="text" name="content1" class="rcol-xs-10 col-sm-5" value="<?php echo $data['content1']; ?>">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 文本2 </label>
									<div class="col-sm-9">
										<input type="text" name="content2" class="rcol-xs-10 col-sm-5" value="<?php echo $data['content2']; ?>">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 文本3 </label>
									<div class="col-sm-9">
										<input type="text" name="content3" class="rcol-xs-10 col-sm-5" value="<?php echo $data['content3']; ?>">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 文本4 </label>
									<div class="col-sm-9">
										<input type="text" name="content4" class="rcol-xs-10 col-sm-5" value="<?php echo $data['content4']; ?>">
										<span class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 背景图 </label>
									<div class="col-sm-9">
										<div id="editor" >
...
<script type="text/javascript">
	var E = window.wangEditor
    	...
    	// 配置服务器端地址
    	editor.customConfig.uploadImgServer = "<?php echo url('background/upload'); ?>";
